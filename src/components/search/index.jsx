    ...
    return (
        <div className={"search-field " + props.className}>
            <TextField
                ...
                onChange={(event, value) => props.onSearchTasks(event, value)}
            />
        </div>
    )
};
function Search(props) {
    return (
        <div className="search">
            <SearchIcon style={iconStyles} onClick={props.onClick} />
            <SearchField
                className={props.className}
                onSearchTasks={ (event, value) => props.onSearchTasks(event, value) }
            />
        </div>
